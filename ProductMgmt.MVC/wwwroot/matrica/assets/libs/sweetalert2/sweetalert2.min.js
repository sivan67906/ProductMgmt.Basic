!(function (e, t) {
    ...
    const Ee = (e, t) => {
        ...
        Te = (e, t) => {
            ...
            i &&
                ((o = i),
                    "string" == typeof (n = t.backdrop) ? (o.style.background = n) : n || C([document.documentElement, document.body], m["no-backdrop"]),
                    (o = i),
                    (n = t.position) in m ? C(o, m[n]) : (r('The "position" parameter is not valid, defaulting to "center"'), C(o, m.center)),
                    (n = i),
                    (o = t.grow) && "string" == typeof o && (o = "grow-".concat(o)) in m && C(n, m[o]),
                    w(i, t, "container"));
        };
    const Le = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        We = (e, t) => {
            let n = e.innerHTML,
                o;
            var i;
            t.iconHtml ? (o = Ke(t.iconHtml)) : "success" === t.icon ? ((o = Fe), (n = n.replace(/ style=".*?"/g, ""))) : (o = "error" === t.icon ? Ue : ((i = { question: "?", warning: "!", info: "i" }), Ke(i[t.icon]))),
                n.trim() !== o.trim() && v(e, o);
        },
        ze = (e, t) => {
            if (t.iconColor) {
        ...
        Ye = (e, t) => {
            var n = g();
            const o = h();
            t.toast ? (a(n, "width", t.width), (o.style.width = "100%"), o.insertBefore(d(), W())) : a(o, "width", t.width),
        ...
        Ze = (e, n) => {
            ...
            B(o),
                ...
                n.progressSteps.forEach((e, t) => {
                    ...
                    o.appendChild(e),
                        t === n.currentProgressStep && C(e, m["active-progress-step"]),
    ...
    function Je() {
        ...
        if (t) {
            ...
            P(n.loader),
                te() ? t.icon && B(W()) : ((t = n), (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? B(e[0], "inline-block") : le() && P(t.actions)),
            ...
            if (o && !n.isComposing && 229 !== n.keyCode)
                if ((o.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key))
                    (e = e),
                        (s = n),
                        (i = o),
                        R(i.allowEnterKey) && s.target && e.getInput() && s.target instanceof HTMLElement && s.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(i.input) || (Ge(), s.preventDefault()));
                else if ("Tab" === n.key) {
                    e = n;
                    var i = o;
                    var r = e.target,
    ...
    const rt = () => {
        ...
        ct = (e) => {
            ...
            return (
                ...
                (n === o || (!ue(o) && n instanceof HTMLElement && "INPUT" !== n.tagName && "TEXTAREA" !== n.tagName && (!ue(K()) || !K().contains(n))))
            );
        },
        lt = () => {
            var e;
    ...
    function pt(e, t, n, o) {
        te() ? ft(e, o) : (ge(n).then(() => ft(e, o)), Qe(E)),
            ...
            ee() && (dt(), lt(), at()),
            A([document.documentElement, document.body], [m.shown, m["height-auto"], m["no-backdrop"], m["toast-shown"]]);
    }
    function mt(e) {
    ...
    const O = (e) => {
        ...
        Ht = (t, n) => {
            ...
            if ((e.showLoaderOnDeny && O(b()), e.preDeny)) {
                ...
                o.then((e) => {
                    !1 === e ? (t.hideLoading(), gt(t)) : t.close({ isDenied: !0, value: void 0 === e ? n : e });
    ...
    const Gt = ["swal-title", "swal-html", "swal-footer"],
        ...
        dn = (e, t, n) => {
            C(e, n.showClass.backdrop),
                ...
                n.heightAuto && n.backdrop && !n.toast && C([document.documentElement, document.body], m["height-auto"]);
        };
    var pn = {
    ...
    const gn = (l, u, d) =>
        new Promise((e, t) => {
            ...
            it.swalPromiseResolve.set(l, e),
                ...
                (r = l),
                "select" === (t = d).input || "radio" === t.input ? Tt(r, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (F(t.inputValue) || U(t.inputValue)) && (O(f()), Lt(r, t));
            {
                var a = d;
                const s = g(),
                    c = h();
                "function" == typeof a.willOpen && a.willOpen(c),
                    ...
                    te() || E.previousActiveElement || (E.previousActiveElement = document.activeElement),
        ...
        fn = (e) => {
            var t = { popup: h(), container: g(), actions: X(), confirmButton: f(), denyButton: b(), cancelButton: y(), loader: d(), closeButton: G(), validationMessage: Z(), progressSteps: Y() };
    ...
    if ("undefined" != typeof window && /^ru\b/.test(navigator.language) && location.host.match(/\.(ru|su|xn--p1ai)$/) && Math.random() < 0.1) {
        ...
        var Cn = (Cn = [
            { text: "В нижеприведённом видео объясняется как каждый из нас может помочь в том,\n        <strong>чтобы эта бессмысленная и бесчеловечная война остановилась</strong>:", id: "4CfDhaRkw7I" },
            { text: "Эмпатия - главное <strong>человеческое</strong> чувство. Способность сопереживать. <strong>Способность поставить себя на место другого.</strong>", id: "s-GLAIY4DXA" },
        ])[Math.floor(Math.random() * Cn.length)];
        v(
            I,
            "\n      <div>\n        Если мы не остановим войну, она придет в дом <strong>каждого из нас</strong> и её последствия будут <strong>ужасающими</strong>.\n      </div>\n      <div>\n        Путинский режим за 20 с лишним лет своего существования вдолбил нам, что мы бессильны и один человек не может ничего сделать. <strong>Это не так!</strong>\n      </div>\n      <div>\n        "
                .concat(Cn.text, '\n      </div>\n      <iframe width="560" height="315" src="https://www.youtube.com/embed/')
                .concat(Cn.id, '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>\n      <div>\n        Нет войне!\n      </div>\n      ')
        );
