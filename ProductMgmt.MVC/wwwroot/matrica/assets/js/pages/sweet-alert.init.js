function executeExample(e) {
    switch (e) {
        ...
        case "threeButtons":
            return void Swal.fire({ title: "Do you want to save the changes?", showDenyButton: !0, showCancelButton: !0, confirmButtonText: "Save", denyButtonText: "Don't save" }).then((e) => {
        ...
        case "customImage":
            return void Swal.fire({ title: "Metrica!", text: "Modal with a Brand Logo.", imageUrl: "assets/images/logo-sm.png", imageWidth: 80, imageHeight: 80, imageAlt: "Custom image" });
        case "customWidth":
            return void Swal.fire({ title: "Custom width, padding, background.", width: 600, padding: 50, background: "rgba(254,254,254,1) url(assets/images/pattern.png)" });
        case "timer":
            let t;
            return void Swal.fire({
        ...
        case "mixin":
            ...
            return void o.fire({ icon: "success", title: "Signed in successfully" });
